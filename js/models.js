    ...
    return {
        ...
        get_medications: function (smart) {
            ...
            return $.Deferred(function (dfd) {
                ...
                smart.fetchAll({type: "MedicationOrder"}).then(doneMeds);
        ...
        get_problems: function (smart) {
            ...
            return $.Deferred(function (dfd) {
                ...
                smart.fetchAll({type: "Condition"}).then(doneProblems);
        ...
        get_allergies: function (smart) {
            ...
            return $.Deferred(function (dfd) {
                ...
                smart.fetchAll({type: "AllergyIntolerance"}).then(doneAllergies);
        ...
        get_vital_sign_sets: function (smart) {
            ...
            return $.Deferred(function(dfd) {
                ...
                smart.fetchAll({type: "Observation", query: {code: {$or: ['8302-2','3141-9','8480-6','8462-4']}}}).then(doneVitals);
